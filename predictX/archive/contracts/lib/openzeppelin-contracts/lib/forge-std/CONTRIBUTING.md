...
When making modifications to the native cheatcodes or adding new ones, please make sure to run [`./scripts/vm.py`](2%20-%20Projects/NUS/FT5004/pdx/archive/contracts/lib/openzeppelin-contracts/lib/forge-std/scripts/vm.py) to update the cheatcodes in the [`src/Vm.sol`](2%20-%20Projects/NUS/FT5004/pdx/archive/contracts/lib/openzeppelin-contracts/lib/forge-std/src/Vm.sol) file.
...
It is possible that the resulting [`src/Vm.sol`](2%20-%20Projects/NUS/FT5004/pdx/archive/contracts/lib/openzeppelin-contracts/lib/forge-std/src/Vm.sol) file will have some changes that are not directly related to your changes, this is not a problem.
